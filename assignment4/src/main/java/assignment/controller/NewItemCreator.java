...
public final class NewItemCreator {
   ...
   */
  public static void checkNumberOfInputArguments(final String... listOfItemDetails) {
   ...
   */
  public static ItemDetails parseItemDetails(final String... listOfItemDetails) {
  ...
  private static Item createItem(final ItemDetails itemDetails) {
    ...
    newItem.setItemName(itemDetails.itemName);
    newItem.setItemType(itemDetails.itemType);
    newItem.setItemPrice(itemDetails.itemPrice);
    newItem.setItemQuantity(itemDetails.itemQuantity);
    return newItem;
  }
